// Create a static function called CompareStudents that takes in two Student objects as parameters and 
// checks to see if their attributes (name and student_id) are the same. 
